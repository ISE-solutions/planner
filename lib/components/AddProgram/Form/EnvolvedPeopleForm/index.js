...
const EnvolvedPeopleForm = ({ isDetail, isDraft, isModel, tags = [], values, persons = [], errors, dictTag, currentUser, programId, setProgram, setValues, setFieldValue, }) => {
    var _a, _b;
    ...
    const approvePerson = (item, index) => {
        ...
        dispatch(updateEnvolvedPerson(item === null || item === void 0 ? void 0 : item.id, programId, {
            ...
            return (React.createElement(Grid, { container: true, spacing: 3, style: { margin: 0, width: '100%' } },
                React.createElement(Grid, { item: true, sm: 12, md: 5, lg: 5 },
                    React.createElement(Box, { display: 'flex', alignItems: 'center' },
                        React.createElement(Autocomplete, { fullWidth: true, noOptionsText: 'Sem Op\u00E7\u00F5es', options: (peopleOptions === null || peopleOptions === void 0 ? void 0 : peopleOptions[index]) || persons, disabled: isDetail, filterSelectedOptions: true, value: item.person, getOptionLabel: (option) => option === null || option === void 0 ? void 0 : option.label, onChange: (event, newValue) => handleChangePerson(index, newValue), getOptionSelected: (option, value) => (option === null || option === void 0 ? void 0 : option.value) === (value === null || value === void 0 ? void 0 : value.value), renderInput: (params) => {
                                var _a, _b, _c, _d;
                    ...
                    ((_a = item === null || item === void 0 ? void 0 : item.function) === null || _a === void 0 ? void 0 : _a.needApprove) &&
                        ...
                        React.createElement(Box, { display: 'flex', justifyContent: 'space-between' }, canApprove(item) && (React.createElement(React.Fragment, null, loading[index] ? (React.createElement(CircularProgress, { size: 15 })) : (React.createElement(Link, { variant: 'body2', onClick: () => handleEditPerson(item, index), style: {
                                fontWeight: 'bold',
                                cursor: 'pointer',
                            } }, "Editar"))))))),
                    React.createElement(Box, { display: 'flex', justifyContent: 'space-between' },
                        ...
                        canApprove(item) &&
                            ...
                            (item === null || item === void 0 ? void 0 : item[`_${PREFIX}pessoa_value`]) &&
                            !isDraft && (React.createElement(Box, { display: 'flex', justifyContent: 'flex-end' }, loading[index] ? (React.createElement(CircularProgress, { size: 15 })) : (React.createElement(Link, { variant: 'body2', onClick: () => approvePerson(item, index), style: { fontWeight: 'bold', cursor: 'pointer' } }, "Aprovar")))))),
                React.createElement(Grid, { item: true, sm: 12, md: 5, lg: 5 },
                    React.createElement(Autocomplete, { options: (functionOptions === null || functionOptions === void 0 ? void 0 : functionOptions[index]) || [], noOptionsText: 'Sem Op\u00E7\u00F5es', filterSelectedOptions: true, disabled: (item === null || item === void 0 ? void 0 : item.isRequired) || !functionOptions[index] || isDetail, getOptionLabel: (option) => option === null || option === void 0 ? void 0 : option[`${PREFIX}nome`], value: item.function, onChange: (event, newValue) => {
                            ...
                            (value === null || value === void 0 ? void 0 : value[`${PREFIX}etiquetaid`]), renderInput: (params) => {
                            var _a, _b, _c, _d;
