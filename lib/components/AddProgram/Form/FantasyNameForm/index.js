...
const FantasyNameForm = ({ values, errors, isDetail, setValues, handleChange, setFieldValue, }) => {
    var _a;
    ...
    return (React.createElement(Box, { overflow: 'hidden auto', display: 'flex', alignItems: 'flex-start', flexDirection: 'column', style: { gap: '10px' }, padding: '.5rem', maxHeight: '25rem', flexGrow: 1 },
        listName.length && !isDetail && (React.createElement(Button, { variant: 'contained', color: 'primary', onClick: handleAddName, startIcon: React.createElement(Add, null) }, "Adicionar")),
