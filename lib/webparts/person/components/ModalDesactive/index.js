...
import { desactivePerson } from '~/store/modules/person/actions';
const ModalDesactive = ({ open, person, notification, handleClose, }) => {
    var _a;
    ...
    const formik = useFormik({
        ...
        onSubmit: (values) => {
            setLoading(true);
            dispatch(desactivePerson(Object.assign(Object.assign({}, values), { data: person }), {
