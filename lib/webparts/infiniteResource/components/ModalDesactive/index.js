...
import { desactiveFiniteInfiniteResource } from '~/store/modules/finiteInfiniteResource/actions';
const ModalDesactive = ({ open, resource, notification, handleClose, }) => {
    var _a;
    ...
    const formik = useFormik({
        ...
        onSubmit: (values) => {
            setLoading(true);
            desactiveFiniteInfiniteResource(Object.assign(Object.assign({}, values), { data: resource }), {
