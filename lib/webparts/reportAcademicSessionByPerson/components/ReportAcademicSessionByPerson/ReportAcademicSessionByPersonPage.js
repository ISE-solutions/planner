...
const ReportAcademicSessionByPersonPage = ({ context }) => {
    ...
    return (React.createElement(Page, { blockOverflow: false, context: context, itemsBreadcrumbs: [
        ...
        ]), cssClassName: styles.wrapperReport, getEmbeddedComponent: (embeddedReportAcademicSessionByPerson) => {
            // @ts-ignore
            window.report = embeddedReportAcademicSessionByPerson;
        } })) : null));
};
export default ReportAcademicSessionByPersonPage;
//# sourceMappingURL=ReportAcademicSessionByPersonPage.js.map