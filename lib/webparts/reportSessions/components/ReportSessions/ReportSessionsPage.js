...
const ReportSessionsPage = ({ context }) => {
    ...
    return (React.createElement(Page, { blockOverflow: false, context: context, itemsBreadcrumbs: [
        ...
        ]), cssClassName: styles.wrapperReport, getEmbeddedComponent: (embeddedReportSessions) => {
            // @ts-ignore
            window.report = embeddedReportSessions;
        } })) : null));
};
export default ReportSessionsPage;
//# sourceMappingURL=ReportSessionsPage.js.map