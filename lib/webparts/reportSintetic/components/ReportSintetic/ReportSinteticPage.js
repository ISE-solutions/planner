...
const ReportSinteticPage = ({ context }) => {
    ...
    return (React.createElement(Page, { blockOverflow: false, context: context, itemsBreadcrumbs: [
            ...
            [
                'loaded',
                () => {
                    console.log('ReportSintetic loaded');
                },
            ],
            [
                'rendered',
                () => {
                    console.log('ReportSintetic rendered');
                },
            ],
            [
                'error',
        ...
        ]), cssClassName: styles.wrapperReport, getEmbeddedComponent: (embeddedReportSintetic) => {
            // @ts-ignore
            window.report = embeddedReportSintetic;
        } })) : null));
};
export default ReportSinteticPage;
//# sourceMappingURL=ReportSinteticPage.js.map