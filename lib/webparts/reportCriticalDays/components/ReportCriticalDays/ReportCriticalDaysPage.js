...
const ReportCriticalDaysPage = ({ context, }) => {
    ...
    return (React.createElement(Page, { blockOverflow: false, context: context, itemsBreadcrumbs: [
        ...
        ]), cssClassName: styles.wrapperReport, getEmbeddedComponent: (embeddedReportCriticalDays) => {
            // @ts-ignore
            window.report = embeddedReportCriticalDays;
        } })) : null));
};
export default ReportCriticalDaysPage;
//# sourceMappingURL=ReportCriticalDaysPage.js.map