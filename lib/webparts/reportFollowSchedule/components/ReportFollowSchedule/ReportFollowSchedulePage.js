...
const ReportFollowSchedulePage = ({ context, }) => {
    ...
    return (React.createElement(Page, { blockOverflow: false, context: context, itemsBreadcrumbs: [
        ...
        ]), cssClassName: styles.wrapperReport, getEmbeddedComponent: (embeddedReportFollowSchedule) => {
            // @ts-ignore
            window.report = embeddedReportFollowSchedule;
        } })) : null));
};
export default ReportFollowSchedulePage;
//# sourceMappingURL=ReportFollowSchedulePage.js.map