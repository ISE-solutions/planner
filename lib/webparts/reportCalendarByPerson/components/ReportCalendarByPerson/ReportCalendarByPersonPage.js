...
const ReportCalendarByPersonPage = ({ context, }) => {
    ...
    return (React.createElement(Page, { blockOverflow: false, context: context, itemsBreadcrumbs: [
        ...
        ]), cssClassName: styles.wrapperReport, getEmbeddedComponent: (embeddedReportCalendarByPerson) => {
            // @ts-ignore
            window.report = embeddedReportCalendarByPerson;
        } })) : null));
};
export default ReportCalendarByPersonPage;
//# sourceMappingURL=ReportCalendarByPersonPage.js.map