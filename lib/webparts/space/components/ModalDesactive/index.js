...
import { desactiveSpace } from '~/store/modules/space/actions';
const ModalDesactive = ({ open, space, notification, handleClose, }) => {
    var _a;
    ...
    const formik = useFormik({
        ...
        onSubmit: (values) => {
            setLoading(true);
            dispatch(desactiveSpace(Object.assign(Object.assign({}, values), { data: space }), {
