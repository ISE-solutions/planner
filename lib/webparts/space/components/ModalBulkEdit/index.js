...
import { bulkUpdateSpace } from '~/store/modules/space/actions';
const ModalBulkEdit = ({ open, spaces, notification, handleClose, }) => {
    ...
    const formik = useFormik({
        ...
        onSubmit: (values) => {
            setLoading(true);
            dispatch(bulkUpdateSpace(Object.assign(Object.assign({}, values), { data: spaces }), {
