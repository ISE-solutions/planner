...
const ListModels = ({ context, canEdit, currentUser, schedule, loading, scheduleChoosed, refetch, filter, setFilter, handleSchedule, }) => {
    ...
    return (React.createElement(React.Fragment, null,
        ...
        React.createElement(ScheduleDayForm, { isModel: true, isScheduleModel: true, visible: visible, schedule: itemSelected, setSchedule: (sch) => setItemSelected(sch), context: context, handleClose: handleClose }),
