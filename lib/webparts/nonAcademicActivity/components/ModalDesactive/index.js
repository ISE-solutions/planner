...
const ModalDesactive = ({ open, academicActivity, notification, handleClose, }) => {
    var _a;
    ...
    const formik = useFormik({
        ...
        onSubmit: (values) => {
            setLoading(true);
            dispatch(desactiveActivity(Object.assign(Object.assign({}, values), { data: academicActivity }), {
    ...
    return (React.createElement(Dialog, { open: open, onClose: onClose, maxWidth: 'md', fullWidth: true },
        React.createElement(DialogTitle, null,
            "Desativar Atividade n\u00E3o Acad\u00EAmica",
