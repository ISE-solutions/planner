...
const ModalBulkEdit = ({ open, tags, notification, handleClose, }) => {
    ...
    const formik = useFormik({
        ...
        onSubmit: (values) => {
            setLoading(true);
            dispatch(bulkUpdateTag(Object.assign(Object.assign({}, values), { data: tags }), {
        ...
        React.createElement(DialogContent, null,
            React.createElement(Grid, { container: true, spacing: 3, style: { margin: 0, width: '100%' } },
                React.createElement(Grid, { item: true, sm: 12, md: 6, lg: 6 },
                    React.createElement(TextField, { fullWidth: true, label: 'Escola de origem', type: 'text', name: 'school', inputProps: { maxLength: 255 }, error: !!formik.errors.school, helperText: formik.errors.school, onChange: formik.handleChange, value: formik.values.school })))),
