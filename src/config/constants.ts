...
export const MOODLE_URL =
  'https://isevirtualcampus.ise.org.br/moodle/webservice/rest/server.php?wstoken=6933f387d7f8cbf489750cc6e22bacbb&wsfunction=contenttype_document_get_documents&moodlewsrestformat=json';
export const TOP_QUANTITY = 10;
export enum TYPE_REQUEST_MODEL {
  CRIACAO = 'Criação',
  UTILIZACAO = 'Utilização',
}
export enum TYPE_ORIGIN_MODEL {
  PROGRAMA = 'Programa',
  TURMA = 'Turma',
