...
interface IReportCalendarByRoomPage {
  context: WebPartContext;
}

const ReportCalendarByRoomPage: React.FC<IReportCalendarByRoomPage> = ({
  context,
}) => {
    ...
    >
      {token ? (
        <PowerBIEmbed
          ...
          getEmbeddedComponent={(embeddedReportCalendarByRoom) => {
            // @ts-ignore
            window.report = embeddedReportCalendarByRoom as any;
          }}
        />
      ) : null}
    </Page>
